...
int main(int argc, char **argv)
{
    ...
    int niter = 500000; // Nr de iteraciones
    int delta_mag; //Cambio de magnetizacion en cada iteracion
    float *ene = malloc(nT*sizeof(float)); //Va guardando energia para T
    float *mag = malloc(nT*sizeof(float)); //Va guardando magnetizacion para T
